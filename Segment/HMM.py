...
class HMM:
            ...
            for line in f.readlines():
                ...
                for k, v in enumerate(line_state):
                    ...
                    if k == 0:
                        ...
                        self.launch_dic[v][word_list[k]] += self.launch_dic.get(word_list[k], 0.0) + 1
    ...
    def cut(self, text):
        ...
        def viterbi(text, state_list, initial_dic, transform_dic, launch_dic):
            ...
            # 第一个字
            for y in state_list:
                V[0][y] = initial_dic.get(y, 0.0) * launch_dic[y].get(text[0], 0)
                path[y] = [y]
        ...
        prob, pos_list = viterbi(text, self.state_list, self.initial_dic, self.transform_dic, self.launch_dic)
